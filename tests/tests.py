...
if __name__=='__main__':
    ...
    if not os.path.isfile("tests/kodim10.png"):
        urllib.request.urlretrieve("http://r0k.us/graphics/kodak/kodak/kodim10.png", "tests/kodim10.png")
    
    img = Image.open('tests/kodim10.png')
    ...
    for sigma in range(0, 10, 1):
        ...
        begin = time.time()
        ssim_skimage = compare_ssim(img, img_noise, win_size=11, multichannel=True, sigma=1.5, data_range=255, use_sample_covariance=False,gaussian_weights=True)
        ...
        print("sigma=%f compare_ssim=%f (%f ms) ssim_torch=%f (%f ms)"%(sigma, ssim_skimage, time_skimage*1000, ssim_torch, time_torch*1000) )
